...
# Configuration
MODEL_PATH     = "models/resnet50_galaxy_classifier.h5"
...
METRICS_DIR = f"predictions/{timestamp}"
...
# Fix for the error: Handle any number of metrics returned
...
predictions_df.to_csv(os.path.join(METRICS_DIR, 'predictions.csv'), index=False)
